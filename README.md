...
- **State-aware load shedding**
  ...
  - Uses **“oldest”** strategy (drop earliest partial matches).
...
## 📊 Performance (Best Configuration)
...
- A synthetic dataset was generated by:
  - Inserting a new “target station”.
  - Planting synthetic hot paths of length 2–5 events.
- Only paths within a 31-minute window are theoretically detectable:
  - 4,400 generated paths/subpaths → 3,155 detectable → max recall ≈ 0.7.
- Engine achieves **recall ≈ 0.55** with **no false positives**  
